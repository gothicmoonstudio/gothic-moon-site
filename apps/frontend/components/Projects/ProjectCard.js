...
const ProjectCard = ({
  ...
  return (
    <div className="w-full md:w-full lg:w-2/3 h-[34rem] p-6 md:p-8 lg:p-12 mt-4 bg-[#F4F3FF] rounded-2xl shadow-lg flex flex-col justify-between gap-6 transition-all duration-300">
