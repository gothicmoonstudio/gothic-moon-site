...
const SecondaryButton = ({ label }) => {
  return (
    <div className="relative h-[54px] px-6 bg-white/15 rounded-full border-[.75px] border-[#f4f3ff] flex justify-center items-center cursor-pointer overflow-hidden transition-all duration-300 ease-in-out hover:animate-halo">
